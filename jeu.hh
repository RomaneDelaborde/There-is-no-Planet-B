...
class Jeu {
	...
	public:
	  ...
	  void solution_enigme_valide(int id_carte_enigme, int val); // modifications en adéquation

	  void combinaison_valide(int id_obj_1, int id_obj_2); // modifications en adéquation)
